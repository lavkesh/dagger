...
public class Constants {
    ...
    public static final String STREAM_SOURCE_DETAILS_SOURCE_NAME_BIGQUERY_SOURCE = "BIGQUERY_SOURCE";
    ...
    public static final String SOURCE_BIGQUERY_START_TIME = "SOURCE_BIGQUERY_START_TIME";
    public static final String SOURCE_BIGQUERY_END_TIME = "SOURCE_BIGQUERY_END_TIME";
    public static final String SOURCE_BIGQUERY_GOOGLE_PROJECT_ID = "SOURCE_BIGQUERY_GOOGLE_PROJECT_ID";
    public static final String SOURCE_BIGQUERY_DATASET_NAME = "SOURCE_BIGQUERY_DATASET_NAME";
    public static final String SOURCE_BIGQUERY_TABLE_NAME = "SOURCE_BIGQUERY_TABLE_NAME";
    public static final String SOURCE_BIGQUERY_TABLE_FIELDS = "SOURCE_BIGQUERY_TABLE_FIELDS";
